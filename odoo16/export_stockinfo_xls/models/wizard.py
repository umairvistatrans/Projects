...
class StockReport(models.TransientModel):
    ...
    def export_xls(self):
        ...
        return self.env.ref('export_stockinfo_xls.applicants_report_xlsx_test').report_action(self.ids, data=data)
        # return {
...
class PartnerXlsx(models.AbstractModel):
    _name = 'report.export_stockinfo_xls.excel_report_history'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        lines = objs.browse(data['ids'])
        d = lines.category
        get_warehouse = objs.get_warehouse(lines)
