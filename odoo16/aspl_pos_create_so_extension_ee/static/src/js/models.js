odoo.define('aspl_pos_create_so_extension_ee.models', function (require) {
"use strict";
...
//    });
    ...
    models.Order = models.Order.extend({
        initialize: function(attr,options){
            ...
            this.set({
                ...
                'invoice_id':false,
                'sale_payment_method': false,
            });
            $('.js_edit_quotation').hide();
        },
        set_attachments : function(images){
            this.attachment = images;
        },
        get_attachments : function(images){
        ...
        export_for_printing: function(){
            ...
            var new_val = {
                ...
                signature: this.get_signature() || '',
                sale_payment_method: this.get_sale_payment_method() || '',
            };
        ...
        set_sale_order_payment_method: function(payment_method) {
            this.set('payment_method_desc', payment_method)
        },
        get_sale_order_payment_method: function() {
            return this.get('payment_method_desc');
        },
        ...
        set_sale_payment_method: function(val){
            this.set('sale_payment_method', val);
        },
        get_sale_payment_method: function() {
            return this.get('sale_payment_method');
        },
    });
    ...
    models.PosModel = models.PosModel.extend({
        ...
        create_sale_order: function(delivery_done){
            ...
            var cashier = order.pos.attributes.cashier.id
            var vals = {
                orderlines: orderLines,
                customer_id: customer_id,
                pos_journal_id: self.config.journal_id[0],
                ...
                attachment: order.get_attachments() || [],
                inv_id: order.get_inv_id() || false,
                order_date: order.get_sale_order_date() || false,
                payment_method: order.get_sale_order_payment_method() || false,
                cashier_id: self.employee.user_id[0],
                employee_id: cashier ,
                ...
                payment_method_desc:order.get_sale_payment_method() || "",
            }
            var params = {
                model: 'sale.order',
